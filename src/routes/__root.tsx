...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "NebulaLearn — Modern learning platform" },
      { property: "og:description", content: "Courses, hackathons, live webinars, a personal cloud drive, and a public project gallery." },
